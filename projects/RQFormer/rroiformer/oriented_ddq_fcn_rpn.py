...
class OrientedDDQFCNRPN(AnchorFreeHead):
    ...
    def _init_layers(self):
        ...
        self.position_embed = nn.Embedding(self.num_proposals, self.feat_channels)
    ...
    def construct_query(self, feat_dict, scores, bboxes, query_ids, num=300):
        ...
        all_img_object_feats = align_tensor(all_img_object_feats, self.num_proposals)
        all_img_proposals = align_tensor(all_img_proposals, self.num_proposals)

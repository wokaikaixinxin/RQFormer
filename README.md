...
**Oriented DDQ** :
|Dataset|mAP|Backbone|lr schd|batch|Angle|Query|Configs|Download|Baidu|魔塔(比百度网盘快)|
|--|--|--|--|--|--|--|--|--|--|--|
